...
$CCC -DWITH_RTL -I/mingw/include -c -o rtl.o ../rtl.c
...
$CCC -s -o acarsdec.exe acarsdec.o acars.o msk.o rtl.o output.o label.o cJSON.o -lws2_32 -lpthread -L/mingw/bin -lrtlsdr
cp acarsdec.exe /mingwbin
````
